...
It is **generated output, not source code** — the actual Flutter/Dart source lives in the main Catdress app repo. This repo just holds the compiled `flutter build web` artifacts that GitHub Pages serves directly from `main`.
